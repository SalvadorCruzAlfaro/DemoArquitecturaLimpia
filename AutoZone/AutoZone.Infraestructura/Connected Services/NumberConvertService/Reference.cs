...
namespace NumberConvertService
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.dataaccess.com/webservicesserver/", ConfigurationName="NumberConvertService.NumberConversionSoapType")]
    public interface NumberConversionSoapType
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<NumberConvertService.NumberToWordsResponse> NumberToWordsAsync(NumberConvertService.NumberToWordsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<NumberConvertService.NumberToDollarsResponse> NumberToDollarsAsync(NumberConvertService.NumberToDollarsRequest request);
    }
    ...
    public partial class NumberToWordsRequest
    {
        ...
        public NumberConvertService.NumberToWordsRequestBody Body;
        
        public NumberToWordsRequest()
        {
        }
        
        public NumberToWordsRequest(NumberConvertService.NumberToWordsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToWordsResponse
    {
        ...
        public NumberConvertService.NumberToWordsResponseBody Body;
        
        public NumberToWordsResponse()
        {
        }
        
        public NumberToWordsResponse(NumberConvertService.NumberToWordsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsRequest
    {
        ...
        public NumberConvertService.NumberToDollarsRequestBody Body;
        
        public NumberToDollarsRequest()
        {
        }
        
        public NumberToDollarsRequest(NumberConvertService.NumberToDollarsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsResponse
    {
        ...
        public NumberConvertService.NumberToDollarsResponseBody Body;
        
        public NumberToDollarsResponse()
        {
        }
        
        public NumberToDollarsResponse(NumberConvertService.NumberToDollarsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface NumberConversionSoapTypeChannel : NumberConvertService.NumberConversionSoapType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class NumberConversionSoapTypeClient : System.ServiceModel.ClientBase<NumberConvertService.NumberConversionSoapType>, NumberConvertService.NumberConversionSoapType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<NumberConvertService.NumberToWordsResponse> NumberConvertService.NumberConversionSoapType.NumberToWordsAsync(NumberConvertService.NumberToWordsRequest request)
        {
            return base.Channel.NumberToWordsAsync(request);
        }
        
        public System.Threading.Tasks.Task<NumberConvertService.NumberToWordsResponse> NumberToWordsAsync(ulong ubiNum)
        {
            NumberConvertService.NumberToWordsRequest inValue = new NumberConvertService.NumberToWordsRequest();
            inValue.Body = new NumberConvertService.NumberToWordsRequestBody();
            inValue.Body.ubiNum = ubiNum;
            return ((NumberConvertService.NumberConversionSoapType)(this)).NumberToWordsAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<NumberConvertService.NumberToDollarsResponse> NumberConvertService.NumberConversionSoapType.NumberToDollarsAsync(NumberConvertService.NumberToDollarsRequest request)
        {
            return base.Channel.NumberToDollarsAsync(request);
        }
        
        public System.Threading.Tasks.Task<NumberConvertService.NumberToDollarsResponse> NumberToDollarsAsync(decimal dNum)
        {
            NumberConvertService.NumberToDollarsRequest inValue = new NumberConvertService.NumberToDollarsRequest();
            inValue.Body = new NumberConvertService.NumberToDollarsRequestBody();
            inValue.Body.dNum = dNum;
            return ((NumberConvertService.NumberConversionSoapType)(this)).NumberToDollarsAsync(inValue);
        }
